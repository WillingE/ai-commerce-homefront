    ...
    <footer className="bg-apple-gray-800 text-white">
      <div className="container max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              <a
                href="https://www.linkedin.com/company/homywork-inc/?viewAsMember=true"
                target="_blank"
        ...
        <div className="border-t border-apple-gray-700 mt-12 pt-8 text-center text-apple-gray-400 text-sm">
          <p>
            &copy; {new Date().getFullYear()} Homywork. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
